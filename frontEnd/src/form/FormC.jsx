...
const FormC = () => {
  ...
  const disabledItems = [
    "model_hgst","date_MFG","driverserial_num_3","driverserial_num_4","country_code","customer_id","customer_hpn_id","customer", "LogoVerification", "customerserial_num_1", "customerserial_num_2", "ds_hkmodel", "mlc", "capacity", "weight",
  ];
  ...
  return (
    ...
    <div className="container mt-5" style={{ fontFamily: 'var(--font-family)', fontWeight:"bold" , marginTop:"50px"}}>
      <h2 className="mb-4" style={{ fontWeight:"bold", marginLeft: "-70px"}}>3.5” Client Standard</h2>
